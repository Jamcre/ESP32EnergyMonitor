...
#define CV1 11392.44671
#define CV2 1000
#define CV3 1000

#define CI1 75.86239186
#define CI2 1000
#define CI3 1000

#define SLA 22 //defining pin 22 as the pin needed for switching relay -K
...
{
  Serial.begin(115200);
  pinMode(SLA, OUTPUT); //setting pin 22 to an output
  /*
  Analog attenuation:
...
// Phase 2 - We arent using phase 2, so this code is irrelevant - K
/*
